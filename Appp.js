...
const Body = () => {
    ...
    var handlePress = (val) => {
        ...
        if (val == 'AC') {
            ...
            switch (operator) {
                case '/':
                    setValue(Number.parseFloat(firstValue)  / Number.parseFloat(secondValue));
                    setFirstValue(Number.parseFloat(firstValue)  / Number.parseFloat(secondValue));
                    setSecondValue('');
                    setOperetor('');
                    break;
                case 'x':
    ...
    console.log("first: " + firstValue, ";\t operator: " + operator + "\t;second: " + secondValue);
